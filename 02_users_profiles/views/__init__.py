...
from .profile import ProfileDetailView, ProfileUpdateView, ProfileCreateView, PublicProfileView, ProfileSettingsView, ProfileCompletionView, ProfileSearchView
...
__all__ = [
    ...
    'ProfileDetailView', 'ProfileUpdateView', 'ProfileCreateView', 'PublicProfileView', 'ProfileSettingsView', 'ProfileCompletionView', 'ProfileSearchView',
